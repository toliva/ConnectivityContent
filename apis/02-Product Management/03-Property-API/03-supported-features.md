...
Property API supports the onboarding of new properties that offer either Expedia Collect products only OR offers both Expedia Collect and Hotel Collect products.  Changing a property's business model is currently not supported via the Property API.
