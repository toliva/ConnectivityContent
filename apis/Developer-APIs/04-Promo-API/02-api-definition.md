...
In case of a duplicate, the service returns an HTTP 409 (Conflict error) indicating a duplicate promotion already exists and the duplicate request is ignored. The service returns error code 3729 or 3730 in the response payload for duplicate request error. See the error table in <Section 10> for error descriptions.

###	Request
The request is sent to the below endpoint:
https://services.expediapartnercentral.com/promotions/v1/hotels/<hotel-id>/promos
